...
export default function IframeModal({
  ...
  // Escape + blokada przewijania tła — ten sam mechanizm co wszystkie inne modale.
  // Wcześniej ten modal miał tylko własny Escape i NIE blokował scrolla body:
  // tło przewijało się pod pełnoekranowym okienkiem na telefonie, a od tego stanu
  // zależy też guard w PullToRefresh (gest nie może odpalać się pod modalem).
