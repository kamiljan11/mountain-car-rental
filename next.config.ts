...
const csp = [
  ...
  // 'self' — okienka w kalendarzu (dane klienta / umowa / checklista) ładują
  // WŁASNE strony apki w iframe (?embed=1). Bez 'self' CSP blokował je wszystkie
  // (broken frame). accounts.google.com — przycisk/one-tap logowania Google.
